...
from travel.sub_agents.booking import prompt
...
ImageAssetSourcingAgent = Agent(
    model="gemini-1.5-flash",
    name="ImageAssetSourcingAgent",
    description="Finds and processes visual assets using web search and generative AI",
    instruction=prompt.IMAGE_SOURCING_INSTR,
